...
export class ManageClientComponent implements OnInit {
  ...
  constructor(private _router : Router,private _service:ClientService,private toastrService: ToastrService,private _globalSettings : GlobalSettings,private _commonService : CommonService) {
