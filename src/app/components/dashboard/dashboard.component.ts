...
export class DashboardComponent implements OnInit {
  ...
  public barChartData: any[] = [
    {data: [65, 75, 80, 81, 76, 55, 40], label: 'Delivered '},
    {data: [28, 38, 40, 19, 56, 37, 15], label: 'Inprogress'}
  ];
  ...
  // Pie
  public pieChartLabels: string[] = ['Delivered', 'Inprogress'];
  public pieChartData: number[] = [500, 230];
