import { ClientSizeService } from './../../../_service/client-size.service';
...
@Component({
  selector: 'app-clientsize',
  templateUrl: './clientsize.component.html',
  styleUrls: ['./clientsize.component.css'],
...
export class ClientsizeComponent implements OnInit {
  ...
  constructor(private _router : Router,private _service:ClientSizeService,private toastrService: ToastrService,private _globalSettings : GlobalSettings,private _commonService : CommonService) {
   ...
   ngOnInit() {
     this.init(1);
     this._commonService.authRedirect('/masters/clientSize');
